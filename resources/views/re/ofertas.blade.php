        ...
        <table id="MyTable" class="display compact table table-striped shadow table-bordered bg-white table-sm table-hover" style="width:100%">
          <thead class="bg-secondary">
            <tr>
              ...
              <th class="text-light text-center">F.SOLICITUD</th>
              <th class="text-light text-center">F.CIERRE</th>
              <th class="text-light text-center">UNIDAD ECONÓMICA</th>
              <th class="text-light text-center">SECCION</th>
              <th class="text-light text-center">PUESTO</th>
              <th class="text-light text-center">VACANTES</th>
              <th class="text-light text-center">PARTICIPANTES</th>
              <th class="text-light text-center">CONTRATADOS</th>
          ...
          <tbody class="text-dark" id="bodyMyTable">
            @foreach($data_ofertas as $ofertas)
              @php
                ...
                { $link='<div onclick="busca_ofl('.$ofertas->id.')" data-bs-toggle="modal" data-bs-target="#modalsoli">'.$ofertas->icono.'</div>';}
                if($ofertas->id_estatus==2)
                { $link='<div onclick="mod_prospectos('.$ofertas->id.')" data-bs-toggle="modal" data-bs-target="#modalprooectos">'.$ofertas->icono.'</div>';}
              @endphp
              <tr>
                <td class="text-center">{{$ofertas->id}}</td>
                <td class="text-center"><span id="fech_sol_{{$ofertas->id}}">{{$fsol[2].'-'.$fsol[1].'-'.$fsol[0]}}</span></td>
                <td class="text-center"><span id="fech_tope_{{$ofertas->id}}">{{$fcie[2].'-'.$fcie[1].'-'.$fcie[0]}}</span></td>
                <td>{{$ofertas->unidad_economica}}</td>
                <td>{{$ofertas->seccion}}</td>
                <td><span id="despue_{{$ofertas->id}}">{{$ofertas->descpue}}</span></td>
                <td class="text-center"><span id="cantsol_{{$ofertas->id}}">{{$ofertas->cantidad}}</span></td>
                <td class="text-center"><span id="cantpart_{{$ofertas->id}}">{{$ofertas->proceso}}</span></td>
                <td class="text-center"><span id="cantcont_{{$ofertas->id}}">{{$ofertas->contratados}}</span></td>
                <td class="text-center"><input id="name_{{$ofertas->id}}" value="{{$ofertas->name}}" type="hidden">                    
                  <div id="divico_{{$ofertas->id}}">@php echo $link; @endphp</div>              
                </td>
              </tr>
            @endforeach
          </tbody>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">        
            ...
            <div class="form-group row mb-2">
              ...
              <div class="form-group row mb-2">          
                <label class="col-sm-3 col-form-label-sm">Planillera:</label>            
                <div class="col-sm-8"> 
                    <input  id="lb_planillera" class="form-control form-control-sm" type="text" value="" aria-label="Disabled input example" disabled readonly>
                </div>
              </div>
          ...
          <div class="modal-body">
            ...
            <!-- ------------------- -->
              <div class="card-header" id="id_card_parti_list">
                <div class="row mb-2">
                  <div class="col-6"><h5 class="text-primary mb-2 mr-2"><b>Participantes</b></h5></div>
                  <div class="col-4 text-end">
                    <button type="button" class="btn btn-primary btn-sm" data-bs-dismiss="modal"><i class="far fa-address-book pr-2"></i> Buscar en BD</button>
                  </div>
                  <div class="col-2">
                    <button type="button" onclick="newpart()" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalnuevoprooectos"><i class="fas fa-user-plus pr-2"></i> Nuevo participante</button>
                  </div>
                </div>
   ...
   <div class="modal fade" id="modaletapas_cont" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        <div class="modal-header bg-light py-1">
          ...
          <div class="d-grid gap-4 d-md-flex justify-content-md-end">
              <button type="button" class="btn btn-primary btn-sm" translate><i class="fas fa-save"></i> Guardar</button><span> </span>
              <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#modalprooectos"><i class="fas fa-ban"></i> Cerrar</button>
          </div>
        </div>
                      ...
                      <form role="form" action="" method="post" class="f1  bg-light">
                                  ...
                                  <div class="card-body">
                                    <div class="form-group row mb-3">
                                      <legend class="col-form-label col-sm-2 pt-0"></legend>
                                        <div class="row mb-2">                    
                                          <div class="col-6" id="div_new_cp">
                                            <label for="filerecord" class="form-label form-label-sm">Adjuntar récord policivo:</label>
                                            <input class="form-control form-control-sm file" name="filerecord" id="filerecord" type="file" accept=".doc,.pdf,image/*">
                                            
                                          </div> 
                                          <div class="col-4" style="display: none" id="div_download_cp">
                                            <span id="download_cp"></span>
                                            <input type="hidden" value='0' id="indica_down_cp">
                              ...
                              <div class="card-body">
                                ...
                                <div class="row my-3">      
                                  ...
                                  <div class="row my-3">
                                    ...
                                    <div class="col-sm-3"> 
                                      <select id="sel_tipo_contrato" class="form-select form-select-sm" onchange="hab_f_terminacion(this)" >
                                        <option value="P" selected>Permanente</option>
                                ...
                                <div class="row my-3">
                                  ...
                                  <div class="row  pt-3 justify-content-md-center">
                                    <div class="col col-lg-auto text-center">
                                      <button type="button" class="btn btn-success" target="_blank" onclick="genera_cartaol()"><span id="div_bto_generacarta"><i class="fas fa-file-pdf fa-xl"></i> Generar Nueva carta de Oferta Laboral</span></button>
                                    </div>
                                  </div>
                                ...
                                <!--  <div class="row mt-3 mb-3 justify-content-md-center">
                                    <div class="col-10">
                                      <table class="table table-hover"  id="table_cartasofl">
                                        <thead>
                                          <tr>
                                            ...
                                            <th class="text-center text-light bg-primary">Aprobación Carta Oferta</th>
                                            <th class="text-center text-light bg-primary">Generar Carta Oferta</th>
                                ...
                                <div class="card">
                                  <div class="card-header py-2 pb-0">
                                    <h6 class="text-secondary fw-bold"><i class="fas fa-handshake text-info fa-lg"></i> Aceptación de oferta laboral</h6>
                                  </div>
                                  <div class="card-body">

                                    <div class="form-group row mt-3 mb-3">
                                      <label class="col-sm-3 col-form-label-sm">Fecha de presentación de oferta: </label>   
                                      <div class="col-sm-2">  
                                        <input  id="f_envio_prueba"name="f_envio_prueba" class="form-control form-control-sm" type="date"> 
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-3">
                                      ...
                                      <div class="col-sm-8">
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="opt_propuesta" id="opt_prop_cancel" value="1" checked onclick="showopt_propuesta(this)">
                                          <label class="form-check-label" for="opt_prop_cancel">En espera</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="opt_propuesta" id="opt_prop_acept" value="2" onclick="showopt_propuesta(this)">
                                          <label class="form-check-label" for="opt_prop_acept">Propuesta aceptada</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="opt_propuesta" id="opt_prop_recha" value="3" onclick="showopt_propuesta(this)">
                                          <label class="form-check-label" for="opt_prop_recha">Propuesta rechazada</label>
                                        </div>
                                      </div>
                                    </div>

                                    <div class="form-group row mb-3 justify-content-md-center" style="display: none" id="div_propuesta_rechazo">
                                      <label for="inputPassword" class="col-sm-2 col-form-label">Motivo del rechazo:</label>
                                      <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 70px"></textarea>
                                      </div>
                                    </div>
    
                                    <div class="form-group row mb-3" style="display: none" id="div_propuesta_aceptada">
                                      <div class="row mb-2 justify-content-md-center">                    
                                        <div class="col-6">
                                          <label for="filepropuesta" class="form-label form-label-sm">Adjuntar propuesta firmada:</label>
                                            <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <fieldset id="div_5">
                          <div class="my-3">
                            ...
                            <div class="card">
                              <div class="card-header py-2 pb-0">
                                <h6 class="text-secondary fw-bold"><i class="fas fa-file-upload text-warning fa-lg"></i> Adjuntar documentación</h6>
                              </div>   
                              <div class="card-body">
                                ...
                                <div class="form-group row mb-3">
                                  <div class="row mb-2">                    
                                    <div class="col-6">
                                      <label for="filepropuesta" class="form-label form-label-sm">Copia de cédula:</label>
                                      <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                    </div>                   
                                    <div class="col-6">
                                      <label for="filepropuesta" class="form-label form-label-sm">Copia de Carné de S.S. o Ficha de S.S.:</label>
                                      <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group row mb-3">
                                  <div class="row mb-2">                    
                                    <div class="col-6">
                                      <label for="filepropuesta" class="form-label form-label-sm">Certificado de Nacimiento:</label>
                                      <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                    </div>             
                                    <div class="col-6">
                                      <label for="filepropuesta" class="form-label form-label-sm">Constancia de Dirección (recibido de agua luz y teléfono):</label>
                                      <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group row mb-3">
                                  <div class="row mb-2">                  
                                    <div class="col-6">
                                      <label for="filepropuesta" class="form-label form-label-sm">Copia de último diploma:</label>
                                      <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                    </div>               
                                    <div class="col-6">
                                      <label for="filepropuesta" class="form-label form-label-sm">Foto tamaño Carnet:</label>
                                      <input class="form-control form-control-sm file" name="filepropuesta" id="filepropuesta" type="file" accept=".doc,.pdf,image/*">
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="card-body"> 
                                    <div class="row my-3">
                                      <div class="form-group row mt-3 mb-3">                  
                                        ...
                                        <label for="sel_entrevista_por" class="col-sm-auto col-form-label-sm">Tipo de relación:</label>
                                        <div class="col-sm-2"> 
                                          <select id="sel_entrevista_por" class="form-select form-select-sm">
                                          </select>
                                        </div>   
                                      
                                        <label for="inputDate" class="col-sm-auto col-form-label-sm">Fecha de Nac.:</label>
                                        <div class="col-sm-2">
                                          <input type="date" class="form-control form-control-sm">
                                        </div>

                                        <span class="col-sm-auto text-end">
                                          <i class="fas fa-plus-square fa-2x activar mt-1" title="Agregar" ></i>
                                        </span>
                                      </div>
                                    </div>
                                    <small>
                                      <table class="table table-sm table-striped table-hover" width='75%'>
                                        <thead>
                                          <tr>
                                            <th class="text-center table-primary">Nombre</th>
                                            <th class="text-center table-primary">Tipo de relación</th>
                          ...
                          <div class="f1-buttons text-end">
                            <button type="button" class="btn btn-sm btn-previous"><i class="fa-solid fa-arrow-left pr-2"></i> Anterior</button>
                            <button type="button" class="btn btn-sm btn-next" id="step_5"><i class="fa-solid fa-arrow-right pr-2"></i> Siguiente</button>
                          </div>
                        </fieldset>
                        <!-- Contratación -->
                        <fieldset id="div_6">                            
                          <div class="my-3">
                            <h5 class="text-primary">5. Generar contrato</h5>
                            
                            
                              <div class="card">
                                <div class="card-header py-2 pb-0">                              
                                  <h6 class="text-secondary fw-bold"><i class="fas fa-file-download text-primary fa-lg"></i> Descargar Contrato</h6>
                                </div>   
                                <div class="card-body">
                                  <div class="row  pt-3 justify-content-md-center">
                                    <div class="col col-lg-auto text-center">
                                      <button type="button" class="btn btn-success"><i class="fas fa-file-pdf fa-xl"></i> Contrato de Trabajo</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <fieldset id="div_7">
                          <div class="my-3" style="display: none">
                            <div class="card">
                              <div class="card-header py-2 pb-0">
                                <h6 class="text-secondary fw-bold"> No procede la contratación</h6> 
                              </div>   
                              <div class="card-body">
                            
                            
                                <div class="form-group row my-3">
                                  <label for="inputPassword" class="col-sm-2 col-form-label">Explicar:</label>
                                  <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 70px"></textarea>
                                  </div>
                                </div>
    ...
    <div class="modal fade" id="modalnuevoprooectos" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog  modal-fullscreen modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header bg-light">
            <h5 class="modal-title text-primary" id="staticBackdropLabel"><i class="fas fa-user-plus fa-lg text-secondary"></i> Agregar Participante</h5>
            <button type="button" onclick="cancel()" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body bg-light">        
            <small>
                              ...
                              <div class="row mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                  ...
                                  <select class="form-select form-select-sm" name="sel_nacionalidad" id="sel_nacionalidad">
                                    <option selected valud='0'>Seleccionar</option>
                              ...
                              <div class="row mb-3">
                                <div class="col-md-2 align-middle">
                                  ...
                                  <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="sel_discapacidad" id="sel_discapacidad">
                                    <option selected valud='NO'>NO</option>
          ...
          <div class="modal-footer bg-light">  
            ...
            <button type="button" onclick="cancel()" class="btn btn-secondary btn-sm" data-bs-dismiss="modal"><i class="fa-solid fa-arrow-left pr-2"></i> Cancelar</button>
...
<script type='text/javascript'>
    ...
    var parametros = {
      ...
      $.ajax({
        ...
        success:  function (data) { 
          document.getElementById("div_bto_generacarta").innerHTML='<i class="fas fa-file-pdf fa-xl"></i> Generar Nueva carta de Oferta Laboral';
          window.open("{{ route('cartapdf') }}?data="+data);

    /*      $("#tbody_cartasofl").html('');
          jQuery(data).each(function(i, item){   
            fterminacion='-';
            if(item.fterminacion!='1900-01-01'){fterminacion=item.fterminacion;}
              contendor  = $("#tbody_cartasofl").html();
              nuevaFila   = '<tr>'+
            '<td><div class="text-center">'+item.id+'</div></td>'+
            '<td><div class="text-center">'+item.salario+'</div></td>'+
            '<td><div class="text-center">'+item.finicio+'</div></td>'+
            '<td><div class="text-center">'+fterminacion+'</div></td>'+
            '<td><div class="text-center"><i class="fas fa-exclamation-triangle fa-lg"></i></div></td>'+
            '<td><div class="text-center"><i class="fas fa-upload fa-lg"></i></div></td>'+
            '<td><div class="text-center"><i class="fas fa-file-pdf fa-lg"></i></div></td>'+
            '<td><div class="text-center"><i class="fas fa-upload fa-lg"></i></div></td>'+
            '</tr>';
      ...
      $.ajax({
        ...
        var nombre_completo="";
          jQuery(data.participante).each(function(i, item){   
            var segnombre='';  var segapellido=''; var tel='No tiene'; var email='No tiene'; var provincia=''; var distrito=''; var corregimiento=''; var direccion=''; var nacionalidad=''; 
            ...
            $('#ld_nom_participante').html(item.prinombre+' '+item.priapellido);
          ...
          document.getElementById('div_'+data.paso).style.display='block';
        ...
        // PASO DE ENTREVISTA INICIAL
          ...
          jQuery(data.prueba_psico).each(function(i, item){
            ...
            $('#sel_evaluacion_aplicada').val(item.id_prueba);

            $('#f_envio_prueba').val(item.f_prueba);
            find_respsico(item.id_prueba,item.txtresp_prueba);

            if(item.rp_docattach!=null)
            {
              document.getElementById('div_new_cp').style="display:none;";
              document.getElementById('div_download_cp').style="display:block;";
              document.getElementById('filerecord').value=""; 
              document.getElementById('download_cp').innerHTML='<a href="'+item.rp_docattach+'" download="RP-'+nombre_completo+'"><i class="fas fa-download"></i> Descargar record policivo</a> <i title="eliminar record policivo" class="fa-solid fa-trash-can dell" onclick=deldoc("rp")></i>';
              document.getElementById('indica_down_cp').value=1;        
            }
          });
  ...
  function deldoc(optdoc)
  {
    var _token = $('input[name="_token"]').val();
    Swal.fire({
      text: "Desea eliminar el record policivo?",
      icon: "question",
      ...
      confirmButtonColor: "#d33",
        ...
        if (result.isConfirmed) 
        {
          ...
          $.ajax({
            ...
            cache: false,       
            beforeSend: function () {
                document.getElementById("download_cp").innerHTML='<div class="spinner-border spinner-border-sm text-primary" role="status"><span class="visually-hidden">Loading...</span></div>';
              }, 
            success:  function (data) { 
              document.getElementById('div_new_cp').style="display:block;";
              document.getElementById('div_download_cp').style="display:none;";
              document.getElementById('filerecord').value=""; 
              document.getElementById('download_cp').innerHTML='';
              document.getElementById('indica_down_cp').value=0;
      ...
      $.ajax({
        ...
        success:  function (data) { 
          jQuery(data).each(function(i, item){
            ...
            document.getElementById("lb_planillera").value=item.planillera;
  ...
  //----PARA CAMBIEN EL ESTADO DE LA OFERTE LABORAL
  function su()
  {
    var _token = $('input[name="_token"]').val();
    ...
    { var parametros = {
      ...
      $.ajax({
        ...
        success:  function (data) { 
          jQuery(data).each(function(i, item){             
            document.getElementById('divico_'+id_ofl_txt).innerHTML='<div onclick="mod_prospectos('+id_ofl_txt+')" data-bs-toggle="modal" data-bs-target="#modalprooectos">'+item.icono+'</div>';
            limpiar();  
  ...
  { 
    ...
    document.getElementById('lb_proceso_part').innerHTML='Pasticipantes: <span class="text-secondary"><b>'+document.getElementById('cantpart_'+id_ofl).innerHTML+'</b></span>';
  ...
  function delprospecto(thisrow,nomtable,idparti)
  {
    ...
    Swal.fire({
      text: "Se eliminará el participante de la solicitud; sin embargo, la hoja de vida querará almacenada en la base de datos.",
      showCancelButton: true,
      icon: "info",
      ...
      confirmButtonColor: "#d33",
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            success:  function (data) { 
              jQuery(data).each(function(i, item){       
                document.getElementById('lb_proceso_part').innerHTML= 'Pasticipantes: <span class="text-secondary"><b>'+data.conteos+'</b></span>';
  ...
  { 
    if(opt.value=='T'){  document.getElementById('lb_f_terminacion').style.display='block'; document.getElementById('f_terminacion').style.display='block';}
    if(opt.value=='P'){   document.getElementById('lb_f_terminacion').style.display='none'; document.getElementById('f_terminacion').style.display='none';}
  }
    //----- MUESTRA SECCIÓN PARA VALIDACIÓN DE REFERENCIAS
  function showentre()
  {   
  ...
  //----- MUESTRA OPCIONES DE LA ACETACIÓN O RACHAZO DE LA PROPUESTA
  function showopt_propuesta(opt)
  { 
    document.getElementById("div_propuesta_aceptada").style.display="none";
    document.getElementById("div_propuesta_rechazo").style.display="none";
    if(opt.value==2){    document.getElementById("div_propuesta_aceptada").style.display="block";}
    if(opt.value==3){    document.getElementById("div_propuesta_rechazo").style.display="block";}
  ...
  // MENSAJE DE ADVETENCIA EN EL LLENADO DEL FORMULARIO DE NUEVO PARTICIPANTE
  ...
  { next_step = true;
    ...
    if(paso<=2)
    {
      ...
      if(next_step) 
      {	if($('#sel_evaluacion_aplicada').val()==0)
        {	$('#msn_sig_p_1').html('');
          $('#msn_sig_p_1').html('<i class="fas fa-exclamation-triangle"></i> Seleccionar la prueba psicométrica');
          $('#sel_evaluacion_aplicada').focus();
          setTimeout(function(){ $('#msn_sig_p_1').html(''); }, 4000);
          next_step = false;
        }else
        {	f_envio_prueba=$('#f_envio_prueba').val();
          if(($('#sel_evaluacion_aplicada').val()<10)&&(f_envio_prueba.length<=0))
          {	$('#msn_sig_p_1').html('');
            $('#msn_sig_p_1').html('<i class="fas fa-exclamation-triangle"></i> Indicar la fecha de envío de la prueba');
            $('#f_envio_prueba').focus();
            setTimeout(function(){ $('#msn_sig_p_1').html(''); }, 4000);
            next_step = false;
          }else
          { 	pruebapsico_resultado=$('#pruebapsico_resultado').val();
            if((pruebapsico_resultado==0)||(pruebapsico_resultado.length<=0))
            {	$('#msn_sig_p_1').html('');
              $('#msn_sig_p_1').html('<i class="fas fa-exclamation-triangle"></i> Indicar el resultado de la prueba psicométrica');
              $('#pruebapsico_resultado').focus();
              setTimeout(function(){ $('#msn_sig_p_1').html(''); }, 4000);
              next_step = false;
            }else
            {
              if(($('#filerecord').val().length<=0) && ($('#indica_down_cp').val()==0))
              {	$('#msn_sig_p_1').html('');
              ...
              {	
                ...
                data.append("sel_evaluacion_aplicada", $('#sel_evaluacion_aplicada').val());
                ...
                data.append("indica_down_cp", $('#indica_down_cp').val());
                data.append("_token", _token);
                ...
                $.ajax({
                  ...
                  //  jQuery(data).each(function(i, item){
                    ...
                    if(document.getElementById('indica_down_cp').value==0)
                    { document.getElementById('div_new_cp').style="display:none;";
                      document.getElementById('div_download_cp').style="display:block;";
                      document.getElementById('filerecord').value=""; 
                      document.getElementById('download_cp').innerHTML='<a href="'+data.newnamecompleto+'" download="RP-'+nombre_completo+'"><i class="fas fa-download"></i> Descargar record policivo</a> <i title="eliminar record policivo" class="fa-solid fa-trash-can dell" onclick=deldoc("rp")></i>';
                      document.getElementById('indica_down_cp').value=1;
                    }
